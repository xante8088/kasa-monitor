...
class PluginSandbox:
    ...
    def __init__(self, plugin_id: str, restrictions: Optional[Dict] = None):
        ...
        self.blocked_modules = set(restrictions.get('blocked_modules', [
...
class PluginLoader:
    ...
    def __init__(self, plugin_dir: str = "./plugins", db_path: str = "kasa_monitor.db",
    ...
    def uninstall_plugin(self, plugin_id: str) -> bool:
        ...
        cursor = conn.cursor()
        cursor.execute(
            "SELECT install_path FROM plugin_registry WHERE plugin_id = ?",
            (plugin_id,)
        )
        row = cursor.fetchone()
    ...
    def list_plugins(self, plugin_type: Optional[PluginType] = None,
                     state: Optional[PluginState] = None) -> List[Dict]:
