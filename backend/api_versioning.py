...
class VersionRegistry:
    ...
    def record_usage(self, version: str, endpoint: str, method: str,
                    client_id: Optional[str] = None, response_time_ms: Optional[float] = None,
...
class VersionedRoute(APIRoute):
    ...
    def __init__(self, path: str, endpoint: Callable, *args, 
                 supported_versions: List[str] = None, **kwargs):
