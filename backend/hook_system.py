...
class HookRegistry:
    ...
    def unregister(self, hook_name: str, plugin_id: Optional[str] = None,
    ...
    def _remove_hook_definition(self, hook_name: str, plugin_id: Optional[str]):
        ...
        if plugin_id:
            ...
            cursor.execute(
                "DELETE FROM hook_definitions WHERE name = ?",
                (hook_name,)
            )
...
class HookManager:
    ...
    def hook(self, hook_name: str, hook_type: HookType = HookType.ACTION,
            priority: HookPriority = HookPriority.NORMAL,
            plugin_id: Optional[str] = None):
    ...
    async def emit(self, event_name: str, data: Any, source: Optional[str] = None,
    ...
    def get_statistics(self, hook_name: Optional[str] = None, 
