...
class Permission:
    ...
    def matches(self, action: PermissionAction, resource_type: ResourceType, 
...
class AdvancedPermissionManager:
    ...
    def grant_group_permission(self,
                              user_id: int,
                              group_id: int,
                              actions: List[PermissionAction]) -> bool:
    ...
    def setup_inheritance(self,
                         ...
                         specific_permissions: Optional[List[str]] = None) -> bool:
    ...
    def _check_inherited_permission(self,
                                   user_id: int,
                                   action: PermissionAction,
                                   resource_type: ResourceType,
