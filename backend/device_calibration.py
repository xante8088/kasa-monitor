...
class DeviceCalibrationManager:
    ...
    def calculate_calibration_factors(self, device_ip: str, 
                                     measurement_type: MeasurementType,
    ...
    def auto_calibrate(self, device_ip: str, reference_device_ip: Optional[str] = None,
    ...
    def validate_calibration(self, profile_id: int, 
                            validation_data: List[CalibrationPoint]) -> Dict[str, Any]:
    ...
    def apply_calibration(self, device_ip: str, measurement_type: MeasurementType,
                         value: float) -> float:
        """Apply calibration to a measurement.
    ...
    def import_calibration_profile(self, profile_data: Dict) -> int:
        ...
        profile = CalibrationProfile(
            ...
            expires_at=datetime.fromisoformat(profile_dict['expires_at']) 
                      if profile_dict.get('expires_at') else None,
    ...
    def _get_calibration_data(self, device_ip: str, 
                             measurement_type: MeasurementType) -> List[CalibrationPoint]:
