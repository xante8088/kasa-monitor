    ...
    def add_ip_rule(self, 
        ...
        try:
            ...
            cursor.execute("""
                ...
                VALUES (?, ?, ?, ?, ?, ?)
            """, (ip_address, cidr_range, rule_type.value, description, expires_at, created_by))
...
class TimeBasedAccessControl:
    ...
    def grant_temporary_access(self,
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?, ?, ?)
        """, (user_id, granted_by, start_time, end_time, 
              json.dumps(permissions) if permissions else None, reason))
