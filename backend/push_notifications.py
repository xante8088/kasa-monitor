...
class PushNotificationManager:
    ...
    async def broadcast(self, notification: PushNotification, 
                       platform: Optional[PushPlatform] = None) -> int:
    ...
    async def _send_notification(self, subscription: PushSubscription, 
    ...
    def _record_notification(self, user_id: int, platform: PushPlatform, 
                           notification: PushNotification, status: str):
